...
type DecodeMappingSet() =
    ...
    static member DecodeMappingSet (source: string) =
        ...
        let mappingSetDecoder = 
            ...
            MappingSet(
                ?Sssom_version = DecodeSssomVersion.DecodeSssomVersion yamlElement,
                ?Curie_map = DecodeCurieMap.DecodeCurieMap yamlElement,
                ...
                ?Extension_definitions = get.Optional.Field "extension_definitions" (Decode.array DecodeExtensionDefinition.Decoder)
            )
        )
