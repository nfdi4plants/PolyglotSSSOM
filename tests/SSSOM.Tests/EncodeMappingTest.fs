...
let ``EncodeMapping should parse mapping object without optional fields in valid TSV `` () =
    let input =
        EncodeMapping.EncodeMapping(
            [
                Mapping(predicate_id = "skos:exactMatch", mapping_justification = "semapv:ManualMappingCuration")
                Mapping(predicate_id = "skos:broadMatch", mapping_justification = "semapv:LogicalReasoning")
                Mapping(predicate_id = "skos:closeMatch", mapping_justification = "semapv:ManualMappingCuration")
            ]
        )
