...
let tests = 
    testList "EncodeMapping Tests" [
        
        testCase "should parse mapping object without optional fields into valid TSV" <| fun _ ->
            let result =
            ...
            Expect.equal result expected "Should correctly encode minimal Mapping objects to a TSV string"

        testCase "should parse mapping object with optional fields into valid TSV" <| fun _ ->
            let result =
                EncodeMapping.EncodeMapping(
                    [
                        Mapping(
            ...
            Expect.equal result expected "Should correctly encode Mapping objects with all optional fields to a TSV string"
    ]